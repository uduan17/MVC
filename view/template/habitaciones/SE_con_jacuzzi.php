...
<center>
  <div class="fotos table-responsive-lg d-flex">
      <img src="../habitaciones/IMG/suite especial3.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/suite especial5.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/suite especial6.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
  </div>
  </center>
  <div class="container1 flex-wrap">
    <div class="fluid">
      <div class="titulo-servi">
        Suite especial con jacuzzi
      </div>
      <hr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color:#053F62;">
          <form action="../confirmarSE_jacuzzi.php" method="post">
            <center>
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="SE con jacuzzi  "> 
