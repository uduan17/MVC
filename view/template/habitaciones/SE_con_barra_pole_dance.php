...
<center>
  <div class="fotos table-responsive-lg d-flex">
      <img src="../habitaciones/IMG/suite especial1.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/suite especial2.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/suite especial4.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
  </div>
  </center>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color:#053F62;">
          <form action="../confirmarSE_barrapoledance.php" method="post">
            <center>
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="SE con barra pole dance  "> 
