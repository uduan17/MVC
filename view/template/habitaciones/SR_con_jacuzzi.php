...
<head>
  ...
  <title>Suites Remodeladas</title>
...
<center>
  <div class="fotos table-responsive-lg d-flex">
      ...
      <img src="../habitaciones/IMG/suite renovada6.jpg"   class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/suite renovada4.jpg"   class="p-1" style="width: 200%; height:300px; border-radius:8px;">
  </div>
</center>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color:#053F62;">
          <form action="../confirmarSR_conjacuzzi.php" method="post">
            <center>
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="SR con jacuzzi  "> 
  ...
  <script defer src="../../js/SR.js"></script>
</body>
