...
<center>
  <div class="fotos table-responsive-lg d-flex">
      <img src="../habitaciones/IMG/SE_decorada1.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/SE_decorada2.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/SE_decorada3.jpg"   class="p-1" style="width: 200%; height:300px; border-radius:8px;">
  </div>
  </center>
  <div class="container1 flex-wrap">
    <div class="fluid">
      <div class="titulo-servi">
        Suite Especial Decorada
      </div>
      <hr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color:#053F62;">
          <form action="../confirmarSE_decoracion.php" method="post">
            <center>
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="SE decorada "> 
