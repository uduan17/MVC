...
<center>
  <div class="fotos table-responsive-lg d-flex">
    <img src="../habitaciones/IMG/suite renovada2.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
    <img src="../habitaciones/IMG/suite especial7.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
    <img src="../habitaciones/IMG/suite especial8.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
  </div>
  </center>
  <div class="container1 flex-wrap">
    <div class="fluid">
      <div class="titulo-servi">
        Suite especial sencilla
      </div>
      <hr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color:#053F62;">
          <form action="../confirmarSE_sencilla.php" method="post">
            <center>
              <input type="email" formnovalidate placeholder="Correo" name="correo" required class="input_select">
              <input type="number" placeholder="Telefono" name="telefono" required pattern="[0-9]{10}" class="input_select">
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="SE sencilla "> 
              ...
              <input type="text" size="4" maxlength="5" onfocus="test(this)" name="codigo" readonly>
            </center>
        </div>
