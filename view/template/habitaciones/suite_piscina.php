...
<body>
  ...
  <div class="fotos table-responsive-lg d-flex">
      <img src="../../img/img_p/Piscina.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/piscina-1.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/Piscina (1).jpg"   class="p-1" style="width: 200%; height:300px; border-radius:8px;">
  </div>
  </center>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color:#053F62;">
          <form action="../confirmar_conpiscina.php" method="post">
            <center>
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="Suite piscina "> 
              ...
              <input type="text" size="4" maxlength="5" onfocus="test(this)" name="codigo" required  readonly>
            </center>
        </div>
