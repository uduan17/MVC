...
<body>
  ...
  <center>
    <div class="fotos table-responsive-lg d-flex">
      <img src="../habitaciones/IMG/junior suite1.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/junior suite2.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/junioe_suite3.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
    </div>
  </center>
  <div class="container1 flex-wrap">
    ...
    <form class="form">
      <h5 class="form_title" id="info">Detalles de la reserva</h5>
  ...
  <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="../confirmarJ.php" method="post">
          <div class="modal-body" style="background-color:#053F62;">
            <center>
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="Js sencilla"> 

              <select class="form_select" aria-label="Default select example" aria-placeholder="gegerrfsdsae" name="tiempo_estadia" id="precio2" onchange="seleccionarPrecio();" required style="width:60%">
                <option default selected>Seleccione las horas</option>
              ...
              <br>
              <strong style="color: white;">De click aqui para obtener codigo</strong> <br>
