...
<center>
  <div class="fotos table-responsive-lg d-flex">
      <img src="../habitaciones/IMG/SR_sencilla1.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/SR_sencilla2.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
      <img src="../habitaciones/IMG/SR_sencilla3.jpg" class="p-1" style="width: 200%; height:300px; border-radius:8px;">
  </div>
  </center>
  <div class="container1 flex-wrap">
    <div class="fluid">
      <div class="titulo-servi">
        Suite Remodelada Sencilla
      </div>
      <hr>
        ...
        <div class="modal-body" style="background-color:#053F62;">
          <form action="../confirmarSR_S.php" method="post">
            <center>
              ...
              <input type="text"  name="nombre_habitacion" required readonly class="input_select" value="SR sencilla  "> 
