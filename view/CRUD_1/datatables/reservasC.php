...
$sql = "SELECT *  FROM usuarios where reserva_programada='Cancelada'";
  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #1f4f73; color:white;">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="index.php" style="color:white; font-size:19px;">Volver</a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <tbody>
            ...
            ?>
              <tr class="text-center">
                ...
                <td><i class="bi bi-trash" style="color: red; cursor:pointer; font-size:20px;" data-bs-toggle="modal" data-bs-target="#a<?php echo $row['id_reserva']; ?>"></i></td>
                <!-- <td><button class="btn btn-success btn-sm rr" data-bs-toggle="modal" data-bs-target="#E</?php echo $row['id_reserva']; ?>">Efectiva</button>
                <button class="btn btn-danger btn-sm rr"  data-bs-toggle="modal" data-bs-target="#C</?php echo $row['id_reserva']; ?>">Cancelado</button></td></td>   -->
              </tr>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="../delete-cancelada.php?id=<?php echo $row['id_reserva']; ?>" class="btn btn-danger"> Si, eliminar</a>
                    </div>
                  </div>
                </div>
              </div>
